...
/*   STEP 1   */
export const leagueID = "1314321039802507264"; // your league ID
export const leagueName = "FL Evolution"; // your league name
...
export const showUpcomingDraft = true;
export const dynasty = true; // true for dynasty leagues, false for redraft and keeper
export const enableBlog = false; // requires VITE_CONTENTFUL_ACCESS_TOKEN and VITE_CONTENTFUL_SPACE environment variables

/*   STEP 2   */
export const homepageText = `
  <p>Welcome to FL Evolution, a 12-team dynasty superflex league!</p>
  <p>This page auto-updates every week with live standings, trades, and transactions from Sleeper.</p>
  <p>Bookmark this page and check back weekly for league insights and power rankings.</p>
`;
...
export const managers = managersData;
